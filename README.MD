...
- [x] import 'express-async-errors' package // will apply try and catch in every route.

#### 404 vs ErrorHandler Middleware

#### Morgan Pacakge

$% morgan will show which route is called and how much it taken the time in terminal $
...
- [x] create token, setup cookie // also do cookie sign
